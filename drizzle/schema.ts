...
export const branches = mysqlTable("branches", {
  ...
  defaultBranchAdminStaffId: int("defaultBranchAdminStaffId"),
  defaultConstructionManagerStaffId: int("defaultConstructionManagerStaffId"),
  defaultFinanceStaffId: int("defaultFinanceStaffId"),
  isActive: boolean("isActive").default(true).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
}, (table) => [
...
export const constructionJobInstructions = mysqlTable("construction_job_instructions", {
  ...
  responseType: varchar("responseType", { length: 64 }).default("check").notNull(),
  responseOptions: json("responseOptions").$type<string[]>(),
  responseRequired: boolean("responseRequired").default(false).notNull(),
  responseHelpText: text("responseHelpText"),
  responseValue: json("responseValue").$type<unknown>(),
...
export const portalDefects = mysqlTable("portal_defects", {
  ...
  classification: varchar("classification", { length: 32 }).default("unclassified").notNull(),
...
export const portalMaintenanceRequests = mysqlTable("portal_maintenance_requests", {
  ...
  constructionJobId: int("constructionJobId").notNull(),
  portalAccessId: int("portalAccessId"),
  requestSource: varchar("requestSource", { length: 32 }).default("portal").notNull(),
  classification: varchar("classification", { length: 32 }).default("unclassified").notNull(),
  reportedByName: varchar("reportedByName", { length: 255 }),
  reportedByContact: varchar("reportedByContact", { length: 255 }),
