...
export const SPEC_FIELDS: SpecFieldDefinition[] = [
  ...
  { value: "specBalGlassSpigots", label: "Bal Glass Spigots", type: "text", section: "Balustrade" },
  ...
  { value: "specElecGpos", label: "Elec GPOs (JSON)", type: "json", section: "Electrical" },
  ...
  { value: "specStairsTotalRise", label: "Stairs Total Rise", type: "num", section: "Stairs" },
  { value: "specStairsWidth", label: "Stairs Width", type: "num", section: "Stairs" },
  { value: "specStairsRiserHeight", label: "Stairs Target Riser Height", type: "num", section: "Stairs" },
  { value: "specStairsGoingDepth", label: "Stairs Going Depth", type: "num", section: "Stairs" },
  { value: "specStairsNosingOverhang", label: "Stairs Nosing Overhang", type: "num", section: "Stairs" },
  { value: "specStairsLandingDepth", label: "Stairs Landing Depth", type: "num", section: "Stairs" },
  { value: "specStairsFlights", label: "Stairs Flights", type: "num", section: "Stairs" },
  { value: "specStairsSteps", label: "Stairs Steps / Treads", type: "num", section: "Stairs" },
  { value: "specStairsGoings", label: "Stairs Goings", type: "num", section: "Stairs" },
  { value: "specStairsActualRiser", label: "Stairs Actual Riser", type: "num", section: "Stairs" },
  { value: "specStairsTotalRun", label: "Stairs Total Run", type: "num", section: "Stairs" },
  { value: "specStairsStringerLength", label: "Stairs Stringer Length", type: "num", section: "Stairs" },
  { value: "specStairsAngle", label: "Stairs Angle", type: "num", section: "Stairs" },
  { value: "specStairsRiser", label: "Stairs Riser Style", type: "text", section: "Stairs" },
  { value: "specStairsTreads", label: "Stairs Tread Material", type: "text", section: "Stairs" },
  { value: "specStairsStringer", label: "Stairs Stringer Material", type: "text", section: "Stairs" },
  { value: "specStairsHandrail", label: "Stairs Handrail", type: "text", section: "Stairs" },
  ...
  { value: "workItemProduct", label: "Work Checklist Product Match", type: "text", section: "Work Checklist Rows" },
  { value: "workItemLabel", label: "Work Checklist Item Label", type: "text", section: "Work Checklist Rows" },
  { value: "workItemUnit", label: "Work Checklist Unit", type: "text", section: "Work Checklist Rows" },
  { value: "workItemNotes", label: "Work Checklist Notes", type: "text", section: "Work Checklist Rows" },
  { value: "lightType", label: "Light Type", type: "text", section: "Electrical Light Rows" },
  { value: "lightQty", label: "Light Row Qty", type: "computed", section: "Electrical Light Rows" },
  { value: "gpoType", label: "GPO Type", type: "text", section: "Electrical GPO Rows" },
  { value: "gpoLocation", label: "GPO Location", type: "text", section: "Electrical GPO Rows" },
  { value: "gpoQty", label: "GPO Row Qty", type: "computed", section: "Electrical GPO Rows" },
  { value: "gpoOnIwp", label: "GPO Install On IWP", type: "computed", section: "Electrical GPO Rows" },
...
const SPEC_TERM_OVERRIDES: Record<string, Partial<SpecDefinedTerm>> = {
  ...
  specPostsFixing: {
    ...
    notes: "Hard-coded specsheet option: Footing, Internal Bracket, or Welded Base Plate. Map this to the posts_fixing product tab and match by specPostsFixing.",
  },
  specWindowEntries: {
  ...
  specElecLights: {
    ...
    notes: "Legacy aggregate number of light fittings. Existing mappings on this field now expand the structured light rows when specElecLightTypes is present.",
  },
  specElecLightTypes: {
    term: "Electrical light rows",
    formulaExamples: ["lightQty"],
    productMatchField: "lightType",
    notes: "Structured light rows from the Electrical section. The engine expands each row using the selected light type and row quantity.",
  },
  lightQty: {
    term: "Light row quantity",
    formulaExamples: ["lightQty"],
    notes: "Formula variable injected while expanding each selected light row.",
  },
  lightType: {
    term: "Light product selector",
    formulaExamples: ["lightQty"],
    productMatchField: "lightType",
    notes: "Use as Product Match Field for light row mappings, matching products such as LED Oyster or LED Downlight.",
  },
  specElecFan: {
    term: "Fan quantity",
  ...
  specElecGpos: {
    term: "GPO rows",
    formulaExamples: ["gpoQty"],
    productMatchField: "gpoType",
    notes: "Structured electrical GPO rows. The engine expands each row using row qty, type, location, and IWP flag.",
  },
  gpoQty: {
    term: "GPO row quantity",
    formulaExamples: ["gpoQty"],
    notes: "Formula variable injected while expanding each GPO row.",
  },
  gpoType: {
    term: "GPO type",
    formulaExamples: ["gpoQty"],
    productMatchField: "gpoType",
    notes: "Use as Product Match Field for GPO row mappings, usually matching products such as Single GPO or Double GPO.",
  },
  gpoLocation: {
    term: "GPO location",
    formulaExamples: ["gpoQty"],
    notes: "Row location such as Indoor or Outdoor. Available for future specialised product matching or notes.",
  },
  gpoOnIwp: {
    term: "GPO on IWP flag",
    formulaExamples: ["gpoOnIwp"],
    notes: "Formula variable set to 1 when the GPO row is marked for IWP installation, otherwise 0.",
  },
  specPlumbFitoffs: {
  ...
  specWallWorkItems: {
    term: "Wall work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured wall work checklist. The engine expands each checked builder-owned row using row qty/unit and product match.",
  },
  specConcreteItemChecks: {
    term: "Concrete work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured concreting checklist. Use workItemQty for row quantity and workItemProduct to match the selected catalogue item.",
  },
  specElecExtraWork: {
    term: "Electrical work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured electrical work checklist. Rows marked By Client are documented but excluded from generated builder pricing.",
  },
  specFloorWorkItems: {
    term: "Floor work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured internal floor/site work checklist. Use row unit and quantity for product pricing.",
  },
  specPlumbChecks: {
    term: "Plumbing work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured plumbing checklist. Use workItemProduct for catalogue matching or leave it blank to match from the checklist item text.",
  },
  specStairsChecks: {
    term: "Stairs work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured stairs checklist. Each checked builder-owned row can generate its own quote item.",
  },
  specStairsType: {
    term: "Stair configuration",
    formulaExamples: ["1"],
    notes: "Straight, L-Shape, or U-Shape. Use as a product match field if each stair configuration has a catalogue item.",
  },
  specStairsSteps: {
    term: "Stair tread count",
    formulaExamples: ["specStairsSteps", "specStairsSteps * specStairsWidth / 1000"],
    notes: "Calculated number of goings/treads from the stair design. Kept as the legacy step quantity for starter stair mappings.",
  },
  specStairsTotalRise: {
    term: "Stair total rise",
    formulaExamples: ["specStairsTotalRise / 1000"],
    notes: "Ground-to-floor/deck rise in millimetres used by the stair calculator.",
  },
  specStairsWidth: {
    term: "Stair clear width",
    formulaExamples: ["specStairsWidth / 1000"],
    notes: "Stair width in millimetres. Combine with tread count for material quantities when required.",
  },
  specStairsStringerLength: {
    term: "Stair stringer length",
    formulaExamples: ["specStairsStringerLength / 1000", "(specStairsStringerLength / 1000) * 2"],
    notes: "Calculated stringer length in millimetres. Multiply by stringer count if pricing lineal metres.",
  },
  specStairsTreads: {
    term: "Stair tread material",
    formulaExamples: ["specStairsSteps"],
    notes: "Matching, Timber, or Aluminium. Use as a product match field where tread products are separated by material.",
  },
  specStairsStringer: {
    term: "Stair stringer material",
    formulaExamples: ["(specStairsStringerLength / 1000) * 2"],
    notes: "Timber, Steel, or Aluminium. Use as a product match field for stringer products.",
  },
  specStairsHandrail: {
    term: "Stair handrail requirement",
    formulaExamples: ["specStairsHandrail === 'Both' ? 2 : specStairsHandrail === 'One Side' ? 1 : 0"],
    notes: "None, One Side, or Both. The stair calculator warns when a handrail is required by rise.",
  },
  specExistingChecks: {
    term: "Existing house work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured checklist for work on the existing house. Use for eaves, fascia, wall, and make-good allowance products.",
  },
  specDemolitionWorkItems: {
    term: "Demolition work checklist rows",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Structured demolition checklist. Add qty/unit/product match per row, then map with productMatch = workItemProduct and qtyFormula = workItemQty.",
  },
  workItemQty: {
    term: "Work checklist row quantity",
    formulaExamples: ["workItemQty", "Math.max(1, workItemQty)"],
    notes: "Formula variable injected while expanding checklist rows. It is the current row's structured quantity, defaulting to 1 if blank.",
  },
  workChecklistQty: {
    term: "Work checklist quantity alias",
    formulaExamples: ["workChecklistQty"],
    notes: "Alias for workItemQty.",
  },
  checklistQty: {
    term: "Checklist quantity alias",
    formulaExamples: ["checklistQty"],
    notes: "Alias for workItemQty.",
  },
  workItemProduct: {
    term: "Work checklist product match",
    formulaExamples: ["workItemQty"],
    productMatchField: "workItemProduct",
    notes: "Use as Product Match Field for section work checklist mappings. It comes from the row Product match field, falling back to the item label.",
  },
  specBalGlassType: {
    term: "Glass balustrade type",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalGlassType",
    notes: "Selected glass balustrade product options, for example Glass Frameless or Glass Semi Frameless. Use with qtyFormula = specBalustradeLM.",
  },
  specBalGlassSpigots: {
    term: "Glass spigot option",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalGlassSpigots",
    notes: "Selected spigot finish/options. This is option text, not a numeric count. Use a product per option; current starter mapping prices by balustrade LM until a dedicated spigot count exists.",
  },
  specBalTubularVertical: {
    term: "Vertical tubular balustrade option",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalTubularVertical",
    notes: "Selected vertical tubular balustrade options. Use with qtyFormula = specBalustradeLM.",
  },
  specBalTubularHorizSlat: {
    term: "Horizontal slat balustrade option",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalTubularHorizSlat",
    notes: "Selected horizontal slat balustrade options. Use with qtyFormula = specBalustradeLM.",
  },
  specBalTubularVertSlat: {
    term: "Vertical slat balustrade option",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalTubularVertSlat",
    notes: "Selected vertical slat balustrade options. Use with qtyFormula = specBalustradeLM.",
  },
  specBalWireType: {
    term: "Wire balustrade type",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalWireType",
    notes: "Selected wire balustrade option. Use with qtyFormula = specBalustradeLM.",
  },
  specBalPrivacy: {
    term: "Privacy balustrade option",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalPrivacy",
    notes: "Selected privacy screen/louvre/slat option. Use with qtyFormula = specBalustradeLM.",
  },
  specBalustradePosts: {
    term: "Balustrade post quantity",
    formulaExamples: ["specBalustradePosts"],
    productMatchField: "specBalPostType",
    notes: "Number of balustrade posts. Use specBalPostType as the product match field and specBalPostColour as the colour field.",
  },
  specBalustradeLM: {
    term: "Balustrade lineal metres",
    formulaExamples: ["specBalustradeLM"],
    productMatchField: "specBalGlassType / specBalTubularVertical / specBalWireType / specBalPrivacy",
    notes: "Lineal metres of balustrade. Pair this quantity with the selected balustrade family field that matches the catalogue product.",
  },
};
