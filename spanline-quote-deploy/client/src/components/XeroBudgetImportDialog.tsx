        ...
        <div className="flex-1 overflow-y-auto space-y-4">
            ...
            {file ? (
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Drop your Xero Project Financials (budget) report here or click to browse
                </p>
          ...
          <div className="bg-muted/50 rounded-lg p-3 text-xs text-muted-foreground space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-0.5">
              <li>Go to Xero → Projects → Reports → Project Financials</li>
              <li>Filter by "Project Item Type contains Estimated expense"</li>
              <li>Export as Excel and upload the file here</li>
            </ol>
            <p className="mt-2">
              <strong>Full refresh:</strong> Each upload replaces all existing budget data. Categories are auto-classified into: Authorities/Councils/Certifiers, Builder's Fees, DA Commissions, Sub Contractors, Stock/Building Costs, and Other.
            </p>
          </div>
