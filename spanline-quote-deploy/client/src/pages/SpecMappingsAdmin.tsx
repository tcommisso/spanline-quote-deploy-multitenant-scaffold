...
type FieldType = "num" | "text" | "json" | "computed";
...
interface SpecField { value: string; label: string; type: FieldType; section: string }
...
const SPEC_FIELDS: SpecField[] = [
  ...
  { value: "specRoofToFloor", label: "Roof to Floor", type: "num", section: "Dimensions & Structure" },
  ...
  { value: "specHouseRoofType", label: "House Roof Type", type: "text", section: "Dimensions & Structure" },
  { value: "specHouseWallType", label: "House Wall Type", type: "text", section: "Dimensions & Structure" },
  ...
  { value: "specGutterSides", label: "Gutter Sides", type: "num", section: "Gutters & Downpipes" },
  { value: "specBoxGutter", label: "Box Gutter", type: "text", section: "Gutters & Downpipes" },
  ...
  { value: "specFinishSheetSize", label: "Sheet Size", type: "text", section: "Roof & Finish" },
  ...
  { value: "specSubfloorM2", label: "Subfloor Area (m²)", type: "num", section: "Flooring" },
  ...
  { value: "specConcreteArea", label: "Concrete Area (m²)", type: "num", section: "Concrete" },
  ...
  { value: "specCutBackEave", label: "Cut Back Eave", type: "text", section: "Existing Structure" },
  ...
  { value: "specArea", label: "⚡ Area (W × L)", type: "computed", section: "Computed" },
  { value: "specPerimeter", label: "⚡ Perimeter (2×(W+L))", type: "computed", section: "Computed" },
...
export default function SpecMappingsAdmin() {
  ...
  const seedTemplatesMutation = (trpc.specItems as any).seedTemplates.useMutation({
    onSuccess: (data: any) => { toast.success(`Created ${data.created} starter templates (${data.skipped} skipped)`); utils.specItems.mappings.list.invalidate(); },
    onError: (e: any) => toast.error(e.message),
  });
